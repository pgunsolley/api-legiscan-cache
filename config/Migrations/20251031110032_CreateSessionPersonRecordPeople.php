...
class CreateSessionPersonRecordPeople extends BaseMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $this
            ->table('session_person_record_people')
            ->addColumn('session_person_record_id', 'integer', $notNull + $unsigned)
